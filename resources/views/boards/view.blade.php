    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button class="btn btn-success" type="button" style="float: right;" data-board="{{json_encode($tasks)}}" data-toggle="modal" data-target="#taskAddModal">Add Task</button>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary" id="taskAddButton">Save</button>
                    </div>
                </div>
            </div>
        </div>
