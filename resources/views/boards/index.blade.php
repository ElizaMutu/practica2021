    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <button class="btn btn-success" type="button" style="float: right;" data-board="{{json_encode($boards)}}" data-toggle="modal" data-target="#boardAddModal">Add Board</button>
            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <button type="button" class="btn btn-primary" id="boardAddButton">Save</button>
                    </div>
                </div>
            </div>
        </div>
